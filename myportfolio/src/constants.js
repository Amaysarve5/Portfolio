...
import vpsLogo1 from './assets/education_logo/sps_logo1.png';
...
export const SkillsInfo = [
  ...
  export const education = [
    ...
    },
    {
      ...
      date: "2023",
      grade: "56.17%",
      desc: "I completed my class 12 education from ,St. Francis De'Sales High School, Nagpur, under the CBSE board, where I studied Physics, Chemistry,Mathematics and Biology (PCMB)",
      degree: "Senior Secondar(XII) - PCMB",
    },
    {
      id: 2,
      img: vpsLogo1,
      school: "Sayona Public School",
      date: "2021",
      grade: "76.40%",
      desc: "I completed my class 10 education from Sayona Public School, Nagpur, under the state board, where I studied foundational subjects.",
      degree: "Secondary(X)",
    },
  ];
  ...
  export const projects = [
    ...
    },
    {
      ...
      description:
        "A fun and interactive Rock, Paper, Scissors game where you challenge the computer using the classic rules of the timeless childhood game.",
      image: stonepaper,
      tags: ["HTML", "CSS","JavaScript"],
      github: "https://github.com/yAmaysarve5/Rock-paper-scissors-.git",
      webapp: "https://rock-paper-scissor-game02.netlify.app/",
    },
    {
      id: 5,
      ...
      image: tictactoe,
      tags: ["HTML", "CSS", "JavaScript"],
      github: "https://github.com/Amaysarve5/tic-tac-toe.git",
      webapp: "https://tic-tac-toe-game-03.netlify.app/",
    },
  ];  