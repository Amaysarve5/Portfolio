...
import resume from '../../assets/work_logo/RenderCV_EngineeringResumes_Theme__4_.pdf'
    ...
    >
      <div className='flex flex-col-reverse md:flex-row justify-between items-center'>
        ...
        that leave a lasting impression.
          ...
          className='inline-block text-white py-3 px-8 rounded-full lg:mt-5 mt-1 text-lg font-bold transition duration-300 transform:hover scale-105'
          style={{
        ...
        gyroscope={true}
        >
          <img src={profileImage} alt="amay sarve"  className='w-full h-full rounded-full object-cover drop-shadow-[0_10px_20px_rgba(130,69,236,0.5)]'/>
          </Tilt>
        </div>
      </div>
    </section>
