    ...
    <section
      ...
      <div className='text-center mb-16'>
        ...
        <p className='text-gray-400 mt-4 text-lg font-semibold'>
          A Showcase of the projects I have worked on, highlight my skills and experience in various technologies.
        </p>
      </div>
            ...
            <div className='flex flex-col'>
              ...
              <div className='lg:p-8 p-6'>
                ...
                <div className='flex gap-4'>
                  <a href={selectedProject.github} target="_blank" rel="noopener noreferrer" className='w-1/2 bg-gray-800 hover:bg-purple-800 text-gray-400 lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold'>View Code</a>
                  <a href={selectedProject.webapp} target="_blank" rel="noopener noreferrer" className='w-1/2 bg-purple-600 hover:bg-purple-800 text-gray-400 lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold'>View Live</a>
                </div>
              </div>
            </div>
          </div>
