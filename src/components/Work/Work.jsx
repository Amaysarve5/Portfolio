            ...
            <div className='flex flex-col'>
              ...
              <div className='lg:p-8 p-6'>
                ...
                <div className='flex gap-4'>
                  ...
                  <a href={selectedProject.webapp} target="_blank" rel="noopener noreferrer" className='w-1/2 bg-gray-800 hover:bg-gray-700 text-body lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-lg text-sm font-semibold'>View Live</a>
                </div>
              </div>
            </div>
          </div>
